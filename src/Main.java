 ...
 *
 */
public class Main extends LoginLogout implements KeyListener, ActionListener{
	...
	static JButton logoutBut = new JButton("LOGOUT");
	static JButton quitBut = new JButton("QUIT");
	...
	public static void main(String[] args) {
		...
		logoutBut.setBounds(270,395,140,60);
		logoutBut.setFont(buttonFont);
		logoutBut.setBackground(Color.decode("#a6a397"));
		logoutBut.setBorder(BorderFactory.createLineBorder(Color.white, 5));
		logoutBut.setForeground(Color.white);
		logoutBut.addActionListener(new Main());
		startFrame.add(logoutBut);
		
		quitBut.setBounds(430,395,140,60);
		quitBut.setFont(buttonFont);
		quitBut.setBackground(Color.decode("#a6a397"));
		quitBut.setBorder(BorderFactory.createLineBorder(Color.white, 5));
		quitBut.setForeground(Color.white);
		quitBut.addActionListener(new Main());
		startFrame.add(quitBut);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == logoutBut) {
			...
			JOptionPane.showMessageDialog(startFrame, "Successfully logged out");
		}
